// Package unix defines constants for Unix Domain Socket-based message types used in the Socket.IO adapter.
...
// across multiple Socket.IO server nodes using Unix Domain Sockets as the message broker.
const (
